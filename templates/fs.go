...
func moduleGoTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "module.go.tpl", size: 407, mode: os.FileMode(438), modTime: time.Unix(1562070033, 0)}
...
func resolverGoTpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "resolver.go.tpl", size: 368, mode: os.FileMode(438), modTime: time.Unix(1562055432, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func schemaGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema.graphql", size: 89, mode: os.FileMode(438), modTime: time.Unix(1562055432, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
